...
Procesador de audio profesional basado en la patente **US4698842** de AudioControl. Carga tu propia canción y aplica el efecto Epicenter para restaurar bajos profundos.
...
- 🎵 **Carga de canciones locales** - El usuario sube su propio archivo de audio
...
- 📱 **App Android** - Empaquetado con Capacitor
- 💰 **Monetizable** - Google AdSense (web) + AdMob (Android)
...
- O haz clic para seleccionar tu canción
...
- 📍 **Banner AdMob en Android** - Banner adaptativo inferior

### Configurar AdSense (Web)
...
2. Actualiza el `appId` de AdMob en `capacitor.config.ts`.
3. Define `VITE_ADMOB_BANNER_ID_ANDROID` con tu banner real (en desarrollo usa el de prueba).
...
- **@capacitor-community/admob** - Anuncios móviles
